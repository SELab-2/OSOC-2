...
export const UserFilter: React.FC<{
    ...
    useEffect(() => {
        if (loading) return;
        search().then();
    }, [sorts, adminFilter, coachFilter, statusFilter]);

    const toggleNameSort = async (e: SyntheticEvent) => {
        e.preventDefault();
        if (loading) return;
        setSorts({
            nameSort: getNextSort(sorts.nameSort),
            emailSort: Sort.NONE,
        });
    };
    ...
    const toggleEmailSort = async (e: SyntheticEvent) => {
        ...
        setSorts({
            nameSort: Sort.NONE,
            emailSort: getNextSort(sorts.emailSort),
        });
    };
    ...
    const search = async () => {
        ...
        if (sorts.nameSort !== Sort.NONE) {
            filters.push(`nameSort=${sorts.nameSort}`);
        }
        ...
        if (sorts.emailSort !== Sort.NONE) {
            filters.push(`emailSort=${sorts.emailSort}`);
        }
                ...
                <div className={styles.query}>
                    <div onClick={toggleNameSort}>
                        ...
                        <div className={styles.triangleContainer}>
                            <div
                                className={`${
                                    sorts.nameSort === Sort.ASCENDING
                                        ? styles.up
                                        : ""
                                } ${
                                    sorts.nameSort === Sort.NONE
                                        ? styles.dot
                                        : styles.triangle
                                }`}
                            />
                ...
                <div className={styles.query}>
                    <div onClick={toggleEmailSort}>
                        ...
                        <div className={styles.triangleContainer}>
                            <div
                                className={`${
                                    sorts.emailSort === Sort.ASCENDING
                                        ? styles.up
                                        : ""
                                } ${
                                    sorts.emailSort === Sort.NONE
                                        ? styles.dot
                                        : styles.triangle
                                }`}
                            />
