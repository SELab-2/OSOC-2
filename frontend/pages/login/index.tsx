        ...
        .then((json) => {
          if (!json.success) {
            setRegisterBackendError(
              "Failed to register. Please check all fields. " + json.reason
            );
        ...
        <div className={styles.loginContainer}>
          ...
          >
            ...
            >
              ...
              <p
                className={`${styles.textFieldError} ${
                  passwordResetMailError !== "" ? styles.anim : ""
                }`}
              >
            ...
            >
              <div className={styles.githublogo}>
                <Image src={GitHubLogo} layout="intrinsic" alt="GitHub Logo" />
              </div>
        ...
        <div className={styles.registerContainer}>
          ...
          >
            ...
            {registerPasswordError === "" && registerPassword !== "" ? (
              ...
              >
                <p className={`${styles.textFieldError} ${scoreToStyle()}`}>
                  Password strength:
                </p>
                <p className={`${styles.textFieldError} ${scoreToStyle()}`}>
                  {scoreToText()}
              ...
              <p
                className={`${styles.textFieldError} ${
                  registerPasswordError !== "" ? styles.anim : ""
                }`}
              >
            ...
            <p
              className={`${styles.textFieldError} ${
                registerConfirmPasswordError !== "" ? styles.anim : ""
              }`}
            >
