...
it('should create 1 new job application skill', async () => {
    ...
    if (job_application && language){
        ...
        const created_job_application_skill = await createJobApplicationSkill(jobApplicationSkill);
        jobApplicationSkill1.JobApplicationSkillId = created_job_application_skill.job_application_skill_id;
        jobApplicationSkill2.JobApplicationSkillId = created_job_application_skill.job_application_skill_id;
        expect(created_job_application_skill).toHaveProperty("job_application_id", jobApplicationSkill1.JobApplicationId);
        expect(created_job_application_skill).toHaveProperty("skill", jobApplicationSkill1.skill);
        expect(created_job_application_skill).toHaveProperty("language_id", jobApplicationSkill1.languageId);
        expect(created_job_application_skill).toHaveProperty("level", jobApplicationSkill1.level);
        expect(created_job_application_skill).toHaveProperty("is_preferred", jobApplicationSkill1.isPreferred);
        expect(created_job_application_skill).toHaveProperty("is_best", jobApplicationSkill1.is_best);
    }
});
...
it('should find all the job_applications skills in the db, 3 in total', async () => {
    ...
    expect(searched_job_application_skills[2]).toHaveProperty("job_application_id", jobApplicationSkill1.JobApplicationId);
    expect(searched_job_application_skills[2]).toHaveProperty("skill", jobApplicationSkill1.skill);
    expect(searched_job_application_skills[2]).toHaveProperty("language_id", jobApplicationSkill1.languageId);
    expect(searched_job_application_skills[2]).toHaveProperty("level", jobApplicationSkill1.level);
    expect(searched_job_application_skills[2]).toHaveProperty("is_preferred", jobApplicationSkill1.isPreferred);
    expect(searched_job_application_skills[2]).toHaveProperty("is_best", jobApplicationSkill1.is_best);
});
...
it('should find the job_applications skill by its id', async () => {
    ...
    expect(searched_job_application_skill).toHaveProperty("level", jobApplicationSkill1.level);
    expect(searched_job_application_skill).toHaveProperty("is_preferred", jobApplicationSkill1.isPreferred);
    expect(searched_job_application_skill).toHaveProperty("is_best", jobApplicationSkill1.is_best);
});

it('should update job application skill based upon id', async () => {
    const updated_job_application_skill = await updateJobApplicationSkill(jobApplicationSkill2);
    expect(updated_job_application_skill).toHaveProperty("job_application_id", jobApplicationSkill2.JobApplicationId);
    expect(updated_job_application_skill).toHaveProperty("skill", jobApplicationSkill2.skill);
    expect(updated_job_application_skill).toHaveProperty("language_id", jobApplicationSkill2.languageId);
    expect(updated_job_application_skill).toHaveProperty("level", jobApplicationSkill2.level);
    expect(updated_job_application_skill).toHaveProperty("is_preferred", jobApplicationSkill2.isPreferred);
    expect(updated_job_application_skill).toHaveProperty("is_best", jobApplicationSkill2.is_best);
});

it('should delete the job application skill based upon id', async () => {
    const deleted_job_application_skill = await deleteJobApplicationSkill(jobApplicationSkill2.JobApplicationSkillId);
    expect(deleted_job_application_skill).toHaveProperty("job_application_id", jobApplicationSkill2.JobApplicationId);
    expect(deleted_job_application_skill).toHaveProperty("skill", jobApplicationSkill2.skill);
    expect(deleted_job_application_skill).toHaveProperty("language_id", jobApplicationSkill2.languageId);
