...
import {createStudent, getAllStudents, getStudent, 
    updateStudent, searchStudentByGender, deleteStudent} from "../../orm_functions/student";
...
it('should create 1 new student', async () => {
    ...
    if (person){
        ...
        expect(created_student).toHaveProperty("student_id", created_student.student_id);
        expect(created_student).toHaveProperty("gender", created_student.gender);
        expect(created_student).toHaveProperty("pronouns", created_student.pronouns);
        expect(created_student).toHaveProperty("phone_number", created_student.phone_number);
        expect(created_student).toHaveProperty("nickname", created_student.nickname);
...
it('should return the students, by searching for gender', async () => {
    ...
    expect(searched_student[1]).toHaveProperty("phone_number", student1.phoneNumber);
