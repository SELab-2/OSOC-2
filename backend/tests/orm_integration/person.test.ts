...
import {createPerson, getAllPersons, getPasswordPersonByEmail,
...
/*it('should find all the persons in the db, 2 in total', async () => {
    ...
    expect(searched_persons[1]).toHaveProperty("github", person3.github);
    expect(searched_persons[1]).toHaveProperty("firstname", person3.firstname);
    expect(searched_persons[1]).toHaveProperty("lastname", person3.lastname);
    expect(searched_persons[1]).toHaveProperty("email", person3.email);
});
...
it('should find person 2 in the db, by searching for its lastname', async () => {
    ...
    expect(searched_person3).toHaveProperty("github", person3.github);
    expect(searched_person3).toHaveProperty("firstname", person3.firstname);
    expect(searched_person3).toHaveProperty("lastname", person3.lastname);
    expect(searched_person3).toHaveProperty("email", person3.email);
});
...
it('should delete the person based upon personid', async () => {
    const deleted_person = await deletePersonById(0);
    expect(deleted_person).toHaveProperty("person_id", 0);
    expect(deleted_person).toHaveProperty("github", null);
