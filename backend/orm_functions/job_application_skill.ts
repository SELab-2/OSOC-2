 ...
 */
 export async function createStudent(jobApplicationSkill: CreateJobApplicationSkill) {
 ...
 */
 export async function updateStudent(jobApplicationSkill: UpdateJobApplicationSkill) {
 ...
 */
 export async function deleteStudent(jobApplicationSkillId: number) {
