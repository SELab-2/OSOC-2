...
/**
 *
 * @param projectId: this is the id of the project for which we want all the
 *     roles
...
/**
 *
 * @param projectId: this is the id of the project for which we want the number
 *     of positions
 * @param projectRoleId: this is the id of the projectRole for which we want the
 *     number of positions
 ...
 * @param projectId: this is the id of the project for which we want all the
 *     roles
 * @returns: returns all the projectroles object togheter with the role objects
 * for that project
 */
...
/**
 *
 * @param projectRole: UpdateProject object with the values that need to be
 *     updated
...
/**
 *
 * @param projectRoleId: the id of the projectRule we are searching the number
 *     of free positions for
 * @return the number of free positions if free (in a promise) else null (if not
 *     found in db)
 */
