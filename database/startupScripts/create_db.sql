...
CREATE TABLE IF NOT EXISTS evaluation (
    ...
    login_user_id         SERIAL           REFERENCES login_user(login_user_id)  ON DELETE SET NULL,
...
CREATE TABLE IF NOT EXISTS contract(
   ...
   information                 TEXT,
   created_by_login_user_id    SERIAL                  REFERENCES login_user (login_user_id)  ON DELETE SET NULL,
